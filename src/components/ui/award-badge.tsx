...
/* Product Hunt award badge with 3D mouse-tracking tilt and animated
   holo overlay. Kept verbatim from 21st.dev apart from React 19 ref
   typing and rel on the external link. Unused until GymGear has a real
   award to show — do not render a fake one. */
